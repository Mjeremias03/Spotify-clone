  ...
  export const Volume = () => (
    ...
    export function Player (){
      ...
      const handleClick = () =>{
        ...
        return(
            <div className="flex flex-row justify-between w-full  bg-black px-4 z-50">
            <div>
            CurrentSpng...
            </div>
            <div className="gird place-content-center gap-4 flex-1">
              <div className="flex justify-center">
                <button className="rounded-full p-2 bg-white " onClick={()=>{isPlaying(!playing)}}>
                  {playing ? <Pause/> : <Play/>}
                </button>
              </div>
            </div>
